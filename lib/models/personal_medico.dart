...
class PersonalMedico {
  ...
  // Construye la entidad desde un registro dinámico.
  factory PersonalMedico.fromMap(Map<String, dynamic> map) {
    return PersonalMedico(
      idMedico: _resolverString(map, const <String>['id_medico', 'id_personal', 'id_usuario', 'id']),
      nombreCompleto: _resolverString(map, const <String>['nombre_completo', 'nombre', 'nombres']),
      especialidad: _resolverString(map, const <String>['especialidad', 'area', 'especializacion']),
      ...
      createdAt: _resolverString(
        map,
        const <String>['created_at'],
        fallback: DateTime.now().toIso8601String(),
      ),
      documento: _resolverString(map, const <String>['documento', 'numero_documento']),
  ...
  // Normalizan valores dinámicos para evitar errores de tipos.
