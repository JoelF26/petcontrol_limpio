...
class Mascota {
  ...
  // Acepta nombres de llaves actuales y variantes antiguas del seed local.
  ...
  // Mantienen el parseo flexible ante números guardados como texto o con unidades.
  ...
  static int? _resolverEntero(
    ...
    for (final llave in llaves) {
      ...
      if (valor is String) {
        // Extrae el primer número útil de textos como "3 años".
  ...
  static double? _resolverDouble(
    ...
    for (final llave in llaves) {
      ...
      if (valor is String) {
        // Acepta coma decimal para pesos escritos como "4,5 kg".
