...
class HomeAdminFunciones {
  ...
  static List<HomeAdminProximaCitaVista> _construirProximasCitas({
    ...
    final futuras = ordenadas.where((cita) {
  ...
  static String _resolverFechaHoraCorta(Cita cita) {
    ...
    final hora = '${_dosDigitos(fechaHora.hour)}:${_dosDigitos(fechaHora.minute)}';
    if (esMismoDia) {
      return 'Hoy $hora';
    }
  ...
  static void abrirDetalleProximaCita(
    ...
    mostrarPopupDetalle(
      ...
      ConfigPopupDetalle(
        ...
        colorAcento: const Color(0xFF2D8A6C),
