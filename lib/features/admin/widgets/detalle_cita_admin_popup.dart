...
class _DetalleCitaAdminPopupState extends State<_DetalleCitaAdminPopup> {
  ...
  void _restaurarValoresOriginales() {
    ...
    _fechaHoraController.text = _formatearFechaHoraVisible(_fechaHoraSeleccionada);
  ...
  String get _nombreMascotaVisible {
    return _mascotaSeleccionada?.nombreVisible ?? widget.cita.nombreMascotaVisible;
  }

  String get _especieVisible {
    return _mascotaSeleccionada?.especieVisible ?? widget.cita.especieMascotaVisible;
  }
                ...
                Wrap(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: const Color(0xFFCFE5DD),
                        borderRadius: BorderRadius.circular(999),
                      ),
                      child: Text(
                        _estadoSeleccionado ?? 'proxima',
                        style: const TextStyle(
                          color: Color(0xFF2D8A6C),
                          fontSize: 13,
                      ...
                      Expanded(
                        child: OutlinedButton(
                          ...
                          style: OutlinedButton.styleFrom(
                            foregroundColor: const Color(0xFF5A616A),
                            side: const BorderSide(color: Color(0xFFA4ABB3)),
                            minimumSize: const Size.fromHeight(44),
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(10),
                            ),
