  ...
  static Future<List<MedicoVista>> cargarPersonalMedico({
    ...
    final lista =
        personal
            .map((medico) {
              final usuario =
                  usuarioPorCorreo[medico.correo.trim().toLowerCase()];
              ...
              return MedicoVista(
                ...
                documento: documentoLimpio.isEmpty
                    ? 'Sin documento'
                    : documentoLimpio,
