...
class _DetallePacienteAdminPopupState extends State<_DetallePacienteAdminPopup> {
  ...
  Future<void> _guardarCambios() async {
    ...
    if (edad == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('La edad debe contener un numero valido.')),
      );
      return;
    }
    ...
    if (peso == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('El peso debe contener un numero valido.')),
      );
      return;
    }
