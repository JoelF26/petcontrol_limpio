      ...
      child: Row(
        ...
        children: [
          IconButton(
            ...
            icon: const Icon(Icons.pets, color: Colors.black, size: 30, fill: 0),
            tooltip: 'Pacientes',
          ),
          IconButton(
            onPressed: onCitas,
          ...
          IconButton(
            ...
            icon: const Icon(Icons.assignment_outlined, color: Colors.black, size: 30),
