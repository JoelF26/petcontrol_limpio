  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColores.baseFFF2F5FA,
        borderRadius: BorderRadius.circular(18),
        border: Border.all(color: AppColores.baseFF93A2B2, width: 1),
        boxShadow: const [
          BoxShadow(
            color: AppColores.base220E1C2F,
            blurRadius: 10,
            offset: Offset(0, 5),
          ),
        ],
          ...
          Row(
            children: [
              Container(
                ...
                height: 30,
                decoration: BoxDecoration(
                  color: AppColores.baseFFDFE8F5,
                  borderRadius: BorderRadius.circular(9),
                ),
                child: Icon(icono, color: AppColores.baseFF1E3D63, size: 18),
              ),
              ...
              TextButton(
                ...
                style: TextButton.styleFrom(
                  foregroundColor: AppColores.baseFF1A6C90,
