...
class HomeClienteMenuFlotante extends StatefulWidget {
  ...
  @override
  State<HomeClienteMenuFlotante> createState() => _HomeClienteMenuFlotanteState();
}
    ...
    return Material(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: const Color(0xFF7A7E83), width: 1),
          boxShadow: const [
            BoxShadow(
              color: Color(0x330E1C2F),
              blurRadius: 12,
              offset: Offset(0, 6),
            ),
          ],
        ...
        child: Column(
          ...
          children: [
            ...
            const Divider(height: 1, thickness: 1, color: Color(0xFFB9BDC1)),
            _filaAccion(
  ...
  Widget _filaAccion({
    ...
    return InkWell(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Icon(icono, color: const Color(0xFF2D695A), size: 28),
