...
class _DetalleMascotaClientePopupState extends State<_DetalleMascotaClientePopup> {
  ...
  void _resetearControladores() {
    ...
    _razaController.text =
        widget.mascota.raza.trim().isEmpty ? '' : widget.mascota.raza;
  ...
  Future<void> _guardarCambios() async {
    ...
    if (edad == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('La edad debe contener un número válido.')),
      );
      return;
    }
    ...
    if (peso == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('El peso debe contener un número válido.')),
      );
      return;
    }
