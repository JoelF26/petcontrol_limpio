...
Future<bool> mostrarDetalleCitaCliente(
...
class _DetalleCitaClientePopup extends StatefulWidget {
  ...
  @override
  State<_DetalleCitaClientePopup> createState() => _DetalleCitaClientePopupState();
}
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        elevation: 0,
                        backgroundColor: const Color(0xFF143B5F),
        ...
        children: [
          ...
          if (!_modoEdicion)
            ...
            DropdownButtonFormField<String>(
              ...
              dropdownColor: const Color(0xFFE9EAEB),
              style: const TextStyle(
                color: Color(0xFF1F2A35),
                fontSize: 16,
                fontWeight: FontWeight.w500,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 7),
          Text(
            _especieController.text.trim().isEmpty ? '-' : _especieController.text.trim(),
            maxLines: 1,
            overflow: TextOverflow.ellipsis,
            style: const TextStyle(
              color: Color(0xFF1F2A35),
